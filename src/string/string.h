...
string_cursor_t *string_createCursor(const string_t *string) __attribute__((nonnull(1)));
...
string_t *string_copy(const string_t *string) __attribute__((nonnull(1)));
// Create a string by converting from a base 10 integer
string_t *string_fromInt(int number);
// Append a string to a string
void string_append(string_t *string, const string_t *string2) __attribute__((nonnull(1, 2)));
...
char string_getCharAt(const string_t *string, size_t index) __attribute__((nonnull(1)));
...
string_t *string_substring(const string_t *string, size_t firstIndex, size_t lastIndex) __attribute__((nonnull(1)));
...
bool string_equalsBuffer(const string_t *string, const char *buffer) __attribute__((nonnull(1, 2)));
// Compare a string to another
bool string_equals(const string_t *string, const string_t *string2) __attribute__((nonnull(1, 2)));
// Free a string
